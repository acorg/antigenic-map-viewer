...
export class Application
{
    ...
    public run() :void {
        ...
        // require([`json!${json_file}`, "amv-level2", "css!test", "acmacs-toolkit", "acmacs-plot-data"], (test_data_2d :AntigenicMapViewer.PlotDataInterface, amv :AntigenicMapViewer.MapWidget) => {
        require(["amv-level2", "css!test", "acmacs-toolkit", "acmacs-plot-data"], (amv :AntigenicMapViewer.MapWidget) => {
