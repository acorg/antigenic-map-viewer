...
export class Application
{
    ...
    public run() :void {
        ...
        require([`json!${json_file}`, "amv-level2", "helvetiker_regular.typeface", "css!test", "acmacs-toolkit", "acmacs-plot-data", "amv-utils"], (test_data_2d :AntigenicMapViewer.PlotDataInterface, amv :AntigenicMapViewer.MapWidget) => {
            ...
            var test_data_2d_x = {
                ...
                styles: {
                    ...
                    styles: [{shape: "circle", size: 5.0, outline_color: "#000", fill_color: "#F00", aspect: 0.75, rotation: 0.5, outline_width: 5},
                             ...
                             {shape: "triangle", size: 2.0, outline_color: "#000", fill_color: "#0F0", outline_width: 55},
                            ],
