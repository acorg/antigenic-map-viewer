...
export class PlotData
{
    ...
    constructor(private plot_data :PlotDataInterface) {
    }
    ...
    public make_styles(circle_geometry :THREE.Geometry, box_geometry :THREE.Geometry, material_class :MaterialClass) :ObjectStyle[] {
        return this.styles().map((style :PlotDataStyle) => new ObjectStyle(style, circle_geometry, box_geometry, material_class));
    }
...
export class ObjectStyle
{
    ...
    constructor(plot_style :PlotDataStyle, circle_geometry :THREE.Geometry, box_geometry :THREE.Geometry, material_class :MaterialClass) {
